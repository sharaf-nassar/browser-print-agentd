...
- [[operations]] — what `RUNBOOK.md` owns: the station lifecycle an admin drives by hand, the
  rollback path, and the hardware checklist that starts where CI stops.
- [[infrastructure]] — the CI gates, the naming gate, and the contract any release path is held to.
